...
const CreateJobCard: React.FC<CreateJobCardProps> = observer(() => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const id = jobCard.id;
    setCreatedJobCardId(id);
    await api.jobcard.client.create(client, id);
                ...
                <div
                  ...
                  <div
                    ...
                    style={{
                      ...
                      justifyContent: "space-around",
                      alignItems: "center",
                      maxHeight: showClientDetails ? "500px":"0px"
                    }}>
                    <div
                      className="uk-flex-column"
                      style={{
