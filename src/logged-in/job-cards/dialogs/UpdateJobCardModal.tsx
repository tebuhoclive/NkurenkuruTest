...
const UpdatedJobCardModal = observer(() => {
  ...
  const handleClientFullNameChange = (
                ...
                <div className="uk-form uk-grid uk-grid-small" data-uk-grid>
                  ...
                  <div className="uk-form-controls uk-width-1-2 ">
                    ...
                    <input
                      ...
                      value={editedJobCard.clientFullName}
                  ...
                  <div className="uk-form-controls uk-width-1-2 ">
                    ...
                    <input
                      ...
                      value={editedJobCard.clientMobileNumber}
                      onChange={(e) => {
                  ...
                  <div className="uk-form-controls uk-width-1-2 ">
                    ...
                    <input
                      ...
                      id="client-mobile"
                      placeholder="Cellphone"
                      value={editedJobCard.clientTelephone}
                      onChange={(e) => {
                        const input = e.target.value;
                        // Allow only numbers and limit the length to 10 digits
                        const sanitizedInput = input
                  ...
                  <div className="uk-form-controls uk-width-1-2">
                    ...
                    <input
                      ...
                      id="client-address"
                      placeholder="Address"
                      value={editedJobCard.clientAddress}
                      onChange={(e) =>
                        setEditedJobCard({
                          ...editedJobCard,
                  ...
                  <div className="uk-form-controls uk-width-1-2 ">
                    ...
                    <input
                      ...
                      id="client-email"
                      placeholder="Email"
                      value={editedJobCard.clientEmail}
                      onChange={(e) =>
                        setEditedJobCard({
                          ...editedJobCard,
