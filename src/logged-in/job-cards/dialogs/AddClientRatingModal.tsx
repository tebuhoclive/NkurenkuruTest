...
const AddClientRatingModal = observer(() => {
  ...
  const onCancel = () => {
    ...
    hideModalFromId(MODAL_NAMES.EXECUTION.CLIENT_RATING_MODAL);
  };
  ...
  return (
    <div className="business-unit-modal uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
      ...
      <h3 className="uk-modal-title">Client Rating</h3>
...
export default AddClientRatingModal;
