...
import MeasureCompanyUpdateQ4ActualModal from "../dialogs/measure-company-update-q4-actual/MeasureCompanyUpdateQ4ActualModal";
...
const MeasureTable = (props: IMeasureTableProps) => {
  ...
  }, [agreement.quarter4Review.status, role]);
...
const CompanyScorecardQ4Cycle = observer((props: IProps) => {
  ...
  if (agreement.quarter3Review.status !== "approved")
    return (
      <ErrorBoundary>
        <NoScorecardData
          title="Company Q3 performance is not approved."
          subtitle="You cannot view Quarter 4 tab if the Quarter 3 results has not yet been approved."
          instruction="Please ensure that the Quarter 3 results is approved/reviewed."
        />
      </ErrorBoundary>
    );
  ...
  return (
    <ErrorBoundary>
      ...
      <ErrorBoundary>
        ...
        <Modal
          modalId={MODAL_NAMES.EXECUTION.COMPANY_MEASURE_UPDATE_Q4_ACTUAL_MODAL}
        >
