...
import DepartmentScorecardQ3ApprovalModal from "../dialogs/department-scorecard-q3-approval/DepartmentScorecardQ3ApprovalModal";
import DepartmentScorecardQ3RejectionModal from "../dialogs/department-scorecard-q3-rejection/DepartmentScorecardQ3RejectionModal";
...
const DepartmentScorecardQ3Cycle = observer((props: IProps) => {
  ...
  const handleApproval = () =>
    showModalFromId(MODAL_NAMES.EXECUTION.DEPARTMENT_Q3_APPROVAL_MODAL);

  const handleRejection = () =>
    showModalFromId(MODAL_NAMES.EXECUTION.DEPARTMENT_Q3_REJECTION_MODAL);
  ...
  if (
    ...
    return (
      <ErrorBoundary>
        <NoScorecardData
          title="Department Q2 performance is not submitted."
          subtitle="You cannot view Quarter 3 tab if the quarter is not yet submitted."
          instruction="Please ensure that the Department Quarter 2 has been reviewed, and submitted."
        />
      </ErrorBoundary>
    );
  ...
  return (
    <ErrorBoundary>
      ...
      {/* Modals */}
      <ErrorBoundary>
        <Modal modalId={MODAL_NAMES.EXECUTION.DEPARTMENT_Q3_APPROVAL_MODAL}>
          <DepartmentScorecardQ3ApprovalModal agreement={agreement} />
        </Modal>
        <Modal modalId={MODAL_NAMES.EXECUTION.DEPARTMENT_Q3_REJECTION_MODAL}>
          <DepartmentScorecardQ3RejectionModal agreement={agreement} />
        </Modal>
      </ErrorBoundary>
    </ErrorBoundary>
  );
