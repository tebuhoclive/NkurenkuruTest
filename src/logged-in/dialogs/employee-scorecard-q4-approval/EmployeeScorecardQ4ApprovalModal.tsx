...
const EmployeeScorecardQ4ApprovalModal = observer(() => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const { MY_SUBJECT, MY_BODY } = MAIL_ASSESSMENT_APPROVED_ME(
      user.displayName,
      me.displayName
    );
  ...
  const onCancel = () => {
    ...
    hideModalFromId(MODAL_NAMES.EXECUTION.SCORECARD_Q4_APPROVAL_MODAL);
  };
  ...
  return (
    <div className="scorecard-approval-modal uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
      ...
      <h3 className="uk-modal-title">Assessment Review Approval</h3>
...
export default EmployeeScorecardQ4ApprovalModal;
